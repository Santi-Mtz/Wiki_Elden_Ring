...
\title{Documentación de Seguridad, Privacidad (LFPDPPP) y PWA}
...
\begin{itemize}
    ...
    \item Sincronizar las estadísticas del portador (ritmo cardíaco, runas) entre el wearable, teléfono y Smart TV.
\end{itemize}
